...
prm = LorPrm3D(2., 0.6, 500., 2., 0.6, 500., 2., 0.6, 500.) # Lorentzian parameters
...
CSV.write("/Users/charliehogg/Dropbox/PhD/1. 3D Project/Data/Ultrastrong/qu_MFGS_3D_prmj_5.csv",  dfMFGS, header = ["T", "sxMFGS", "syMFGS", "szMFGS"]) # Export for Mac
# CSV.write("C:/Users/crh222/QuantumSpinDynamics/qu_MFGS_3D_prmf_5.csv",  dfMFGS, header = ["T", "sxMFGS", "syMFGS", "szMFGS"]) # Export for Windows